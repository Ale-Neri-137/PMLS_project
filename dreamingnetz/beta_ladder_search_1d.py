...
from ._1d_ladder_helpers import SysConfig_1d, pool_orchestrator_stats_1d
...
def save_optimal_ladder(path: str, sys: SysConfig_1d, acc_edge_mean: Optional[np.ndarray] = None):
...
def ladder_search_parallel(
    ...
    while passes < max_passes:
        ...
        results = pool_orchestrator_stats_1d(sys_now, trial, R_workers, R_total, start_method=start_method)
